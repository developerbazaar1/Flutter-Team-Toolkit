...
class _DashboardPageState extends State<DashboardPage> {
  final GlobalKey _scoreKey1 = GlobalKey();
  final GlobalKey _scoreKey2 = GlobalKey();
  final GlobalKey _scoreKey3 = GlobalKey();

  @override
  void initState() {
    super.initState();
    // Delay the showcase start to ensure proper initialization
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ShowCaseWidget.of(context).startShowCase([_scoreKey1, _scoreKey2, _scoreKey3]);
    });
  }
